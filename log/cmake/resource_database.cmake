...
function(se_create_resource_database)
    ...
    set(TEMPLATE_SOURCE_FILE ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../tools/ResourceDatabase.cpp.in)
    ...
    add_custom_command(
            ...
            COMMAND ${CMAKE_NM} -uC $<TARGET_OBJECTS:${SE_LOG_DB_TARGET}> | python3 ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../tools/create_resource_database.py ${TEMPLATE_SOURCE_FILE} ${GENERATED_SOURCE_FILE} ${GENERATED_DATABASE_FILE}
