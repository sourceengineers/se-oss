function(se_create_resource_database)
    ...
    set(GENERATED_SOURCE ${CMAKE_CURRENT_BINARY_DIR}/SeResourceDatabase.cpp)
    ...
    add_custom_command(
            ...
            COMMAND ${CMAKE_NM} -uC $<TARGET_OBJECTS:${SE_LOG_DB_TARGET}> | python3 ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../tools/create_resource_database.py ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../tools/ResourceDatabase.cpp.in ${GENERATED_SOURCE} ${CMAKE_CURRENT_BINARY_DIR}/se_log_resource_database.json
